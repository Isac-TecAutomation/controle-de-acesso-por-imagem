...
# ==============================================
SSID = "<o SSID da sua rede>"  # Nome da rede Wi-Fi (SSID)
PASSWORD = "< A senha da sua rede>"  # Senha da rede Wi-Fi
API_HOST = "<O Host da sua API>"  # URL base do servidor da API
DIR = "<Diretório para seu endpoint desejavel>" #diretório para o endpoint na API

# ==============================================
# outras Varivaveis
# ==============================================

# Duração para manter os LEDs ligados (em ms)
led_duration = 'tempo de execução dos leds (int)'  
